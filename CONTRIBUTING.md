...
some other ruleset that depends on rules_sqlc, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_sqlc=$(pwd)/rules_sqlc"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_sqlc` on your system will point to this folder.
...
https://github.com/regb/rules_sqlc/actions/workflows/tag.yaml
