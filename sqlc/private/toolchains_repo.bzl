...
# By default all these toolchains are registered by the sqlc_register_toolchains macro
...
toolchain(
    ...
    toolchain = "@{user_repository_name}_{platform}//:sqlc_toolchain",
    toolchain_type = "@regb_rules_sqlc//sqlc:toolchain_type",
)
""".format(
            platform = platform,
